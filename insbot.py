...
print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
print("\n\n\n\n\n\nLogged in as " + name + "\n")
print("Slow and safemode (Better for longer sessions [+1 HOUR]) [s] | Fast, but riskmode to get blocked after a time (Better for short sessions [1-60 MINUTES]) [f]")
mode = raw_input()
print("\n\n")
...
def followbot(accountlist, followtime, unfollowtime):
...
def likeandunlikebot(liketime, unliketime):
...
if mode == "f":
    if option == "0":
        ...
        if optionlist == "0":
            ...
            followbot(popularaccounts,6,3)
        elif optionlist == "2":
            followbot(germanaccounts, 6,3)
        else:
    ...
    if option == "0":
        ...
        if optionlist == "0":
            ...
            followbot(popularaccounts, 29, 14)
        elif optionlist == "2":
            followbot(germanaccounts, 29, 14)
        else:
            print("Unknown option...")
            time.sleep(2)
    elif option == "2":
    ...
    print("ERROR: MODE ISN'T VALIABLE...")
    time.sleep(3)
